package com.wendritp.catetin.ui.addedittask
...
import com.wendritp.catetin.R
import com.wendritp.catetin.databinding.FragmentAddEditTaskBinding
import com.wendritp.catetin.util.exhaustive
...
class AddEditTaskFragment : Fragment(R.layout.fragment_add_edit_task) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            tvTaskDateCreated.text = "Dibuat Pada ${viewModel.task?.createdFormatted}"
